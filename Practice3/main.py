...
file_folder = Path(__file__).parent  # file is more accurate than cwd
...
while True:
    ...
    while True:
        print('Please choose an algorithm to display, or input c to checkout another map, '
              'or input d to enable or disable gif saving. ')
